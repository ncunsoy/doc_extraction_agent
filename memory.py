...
Saves successfully resolved questions to JSON. When a new question arrives, finds the most similar 
past examples via embedding similarity and passes them to the Reformer as few-shot examples.
Shares the Gemini-based _embed from vector_store to keep a single embedding mechanism.
"""
