...
# Instantiate without triggering API calls
...
print("[TEST 2] Reformer - Code fence stripping")
...
text = "{broken"
out  = validator._parse(text)
assert out.verdict is False, f"verdict should be False for malformed JSON, got: {out.verdict}"
print(f"  verdict : {out.verdict}")
print(f"  PASS\n")
